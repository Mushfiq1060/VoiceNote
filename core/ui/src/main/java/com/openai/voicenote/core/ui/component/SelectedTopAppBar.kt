            ...
            IconButton(
                ...
                DropdownMenu(
                    ...
                    DropdownMenuItem(
                        text = {
                            Text(
                                text = if (archiveStatus) {
                                    stringResource(id = R.string.core_ui_unarchive)
                                } else {
                                    stringResource(id = R.string.core_ui_archive)
                                },
                    ...
                    if (selectedCount == 1) {
                        DropdownMenuItem(
                            text = {
                                Text(
                                    text = stringResource(id = R.string.core_ui_make_a_copy),
                                    style = MaterialTheme.typography.bodyMedium
                                )
                            },
                            onClick = {
