...
import com.openai.voicenote.ui.navigation.graphs.DrawerNavGraph
...
fun AppDrawer(
    ...
    val gestureEnabled by rememberSaveable {
        mutableStateOf(true)
    }
    ...
    ModalNavigationDrawer(
        ...
        DrawerNavGraph(navController = navController, drawerState = drawerState)
    }
